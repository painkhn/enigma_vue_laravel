...
<template>
    <div class="profileComments">
        ...
        <form @submit.prevent="createProfileComment" action="" method="POST" class="themesComments__form flex flex-col mb-5">
            <!-- <p>{{props.theme.id}}</p> -->
            <label for="" class="themesComments__form-label mb-1 text-gray-600 font-semibold dark:text-white/90">Введите комментарий</label>
            <input v-model="content" type="text" class="themesComments__form-input dark:bg-zinc-600 dark:focus:bg-zinc-500 dark:placeholder:text-white/60 dark:text-white/90 placeholder:text-gray-400 mb-5 w-full h-10 transition-all border-gray-400 focus:ring-red-400 focus:border-red-400 rounded text-gray-600" placeholder="Ваш комментарий">
