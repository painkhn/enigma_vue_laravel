...
<template>
    <div class="header__search justify-self-center w-full">
        <form @submit.prevent="searchThemes" action="" method="POST" class="header__search-form flex items-center">
            <input v-model="word" @input="searchWord" type="search" name="word" id="" class="header__search-input w-full focus:bg-white dark:bg-zinc-800 bg-gray-100 dark:focus:bg-zinc-700 text-gray-800 outline-none px-4 h-8 rounded-md focus:ring-1 focus:ring-red-400 focus:ring-offset-red-400 focus:ring-offset-0 transition-all border focus:border-red-400 focus:outline-none dark:border-red-400 focus:shadow-md dark:focus:shadow-black" placeholder="Поиск...">
